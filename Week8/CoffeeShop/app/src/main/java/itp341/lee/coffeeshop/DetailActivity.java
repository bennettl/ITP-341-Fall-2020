...
public class DetailActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_POSITION = DetailActivity.class.getPackage().getName() + "position";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null){
            ...
            if (position > -1){
                ...
                CoffeeShop coffeeShop = CoffeeShopSingleton.get(this).getCoffeeShop(position);
                loadData(coffeeShop);
            }
